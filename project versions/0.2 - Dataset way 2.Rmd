...
Cases_filtered = tidy_joined_dataset %>%
  dplyr::select(c(Country, Stringency_Index, Economic_Support_Index, Population2019, cumulative_confirmed_cases_per_10000, diabetes_prevelance_2019, Smoking_prevalence_15_2016, service_coverage_index_2017, age_population_prop_2019 ))
...
first_model <- lm(cumulative_confirmed_cases_per_10000 ~  Stringency_Index + Economic_Support_Index  + poly(age_population_prop_2019,2) + service_coverage_index_2017 , data = tidy_joined_dataset)


first_model_2 <- lm(cumulative_confirmed_cases_per_10000 ~  Stringency_Index + Economic_Support_Index + Smoking_prevalence_15_2016  + age_population_prop_2019 , data = tidy_joined_dataset)

first_model_1 <- lm(cumulative_confirmed_cases_per_10000 ~  Stringency_Index + Economic_Support_Index + diabetes_prevelance_2019 + Smoking_prevalence_15_2016 + age_population_prop_2019 , data = tidy_joined_dataset)
...
model_transf <- lm(cumulative_confirmed_cases_per_10000_transf ~ Stringency_Index + Economic_Support_Index  + age_population_prop_2019 , data = tidy_joined_dataset)

model_transf_0 <- lm(cumulative_confirmed_cases_per_10000_transf ~ Stringency_Index + Economic_Support_Index + Smoking_prevalence_15_2016 + service_coverage_index_2017 + age_population_prop_2019 , data = tidy_joined_dataset)

model_transf_1 <- lm(cumulative_confirmed_cases_per_10000_transf ~ Stringency_Index + Economic_Support_Index  + diabetes_prevelance_2019 + Smoking_prevalence_15_2016 + service_coverage_index_2017 + age_population_prop_2019 , data = tidy_joined_dataset)

model_transf_2 <- lm(cumulative_confirmed_cases_per_10000_transf ~ Stringency_Index + Economic_Support_Index_levels  + diabetes_prevelance_2019 + Smoking_prevalence_15_2016 + service_coverage_index_2017 + age_population_prop_2019 , data = tidy_joined_dataset)

model_transf_3 <- lm(cumulative_confirmed_cases_per_10000_transf ~ Stringency_Index + Economic_Support_Index  + diabetes_prevelance_2019 + poly(Smoking_prevalence_15_2016,3) + poly(service_coverage_index_2017,3)+ age_population_prop_2019 , data = tidy_joined_dataset)
...
```{r rez_D_transf, fig.cap = "Figure 16. Residuals graph for the diabetes_prevelance_2019 after the transformation, with a Lowess curve in blue and a horizontal line at zero in red.", fig.align = "center"}


ggplot(tidy_joined_dataset, aes(x = diabetes_prevelance_2019, y = rstandard_val_t)) +
  geom_point(shape = 1) +
  geom_hline(yintercept = 0,  size = 0.5, colour= "purple") +
  geom_smooth(method = "loess", se = FALSE, size = 0.5, colour="blue") +
  labs(y = "rstandard", x = "diabetes_prevelance_2019") +
...
```{r rez_SCI_transf, fig.cap = "Figure 16. Residuals graph for the service_coverage_index_2017 after the transformation, with a Lowess curve in blue and a horizontal line at zero in red.", fig.align = "center"}


ggplot(tidy_joined_dataset, aes(x = service_coverage_index_2017, y = rstandard_val_t)) +
  geom_point(shape = 1) +
  geom_hline(yintercept = 0,  size = 0.5, colour= "purple") +
  geom_smooth(method = "loess", se = FALSE, size = 0.5, colour="blue") +
  labs(y = "rstandard", x = "service_coverage_index_2017") +
