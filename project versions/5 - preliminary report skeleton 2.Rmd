...
```{r  spline_model_1, "Figure 22. Interactive Scatterplot for the cumulative confirmed cases per 10,000 (raised to 0.2) for individual countries against their government response measured by the Stringency Index. The purple line is the spline, with its associated 95% CI and PI band.", fig.align = "center"}
...
```{r  spline_model_1_NM,  "Figure 23. Interactive Scatterplot for the cumulative confirmed cases per 10,000 (raised to 0.2) for individual countries against their nurses and midwives per 1000 in 2018. The purple line is the spline, with its associated 95% CI and PI band.", fig.align = "center"}
...
```{r  spline_model_1_APP,  "Figure 24. Interactive Scatterplot for the cumulative confirmed cases per 10,000 (raised to 0.2) for individual countries against their Proportion of population that is 15-64 years old, in 2019. The purple line is the spline, with its associated 95% CI and PI band.", fig.align = "center"}
...
```{r  spline_model_1_SP,  "Figure 25. Interactive Scatterplot for the cumulative confirmed cases per 10,000 (raised to 0.2) for individual countries against their Smoking prevalence for 15+ year olds in 2016. The purple line is the spline, with its associated 95% CI and PI band.", fig.align = "center"}
...
```{r  spline_model_1_ES,  "Figure 26. Interactive Scatterplot for the cumulative confirmed cases per 10,000 (raised to 0.2) for individual countries against their government response measured by the Economic Support Index. The purple line is the spline, with its associated 95% CI and PI band.", fig.align = "center"}
...
```{r  spline_model_2,  "Figure 27. Interactive Scatterplot for the cumulative confirmed cases per 10,000 (raised to 0.2) for individual countries against their government response measured by the Stringency Index, where EI is categorical. The purple line is the spline, with its associated band.", fig.align = "center"}
